...
namespace QuanLyCay
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            con.ConnectionString = @"Data Source = (LocalDB)\MSSQLLocalDB; AttachDbFilename =D:\TreeManager\QuanLyCay\QuanLyCay\QuanLyCay\QuanLyCay.mdf; Integrated Security = True; Asynchronous Processing = True; User Instance = False; Context Connection = False";
            con.Open();                  //Mở kết nối
                                         //Kiểm tra kết nối
        ...
        //Phương thức thực thi Select lấy dữ liệu
